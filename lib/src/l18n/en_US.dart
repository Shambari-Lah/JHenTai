...
Example 2: Block comments with a score not exceeding 10————Comment Score <= 10
    ''',
      ...
      'other': 'Other',
      'visualTranslation': 'Visual Translation',
      'visualTranslationHint': 'Recognize and translate speech bubbles and onomatopoeia in real time',
      ...
      'ocrEngineAuto': 'Auto',
      'ocrEngineAutoDesc': 'Auto (Cloud Vision if API key is set, otherwise Local Enhanced)',
      'ocrEngineLocal': 'Enhanced Local Preprocessing',
      'ocrEngineLocalDesc': 'Local Preprocessing (contrast enhancement, tone removal, bg sampling)',
      'cloudVisionApiKeyNotSet': 'Not set (Tap to configure)',
      'cloudVisionApiKeyHint': 'Enter your Cloud Vision API key from Google Cloud Console. If not set, local OCR preprocessing engine will be used.',
      'clearTranslationCache': 'Clear Translation Cache',
      'clearTranslationCacheHint': 'Reset cached translation text and detected bubble locations',
      'howToUseTranslation': 'How to use Visual Translation',
      'howToUseTranslationStep1': '1. Open any reader (manga or gallery).',
